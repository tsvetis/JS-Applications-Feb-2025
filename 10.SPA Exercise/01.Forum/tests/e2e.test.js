...
describe('E2E tests', function () {
  ...
  describe('Forum', () => {
    it('Show Posts', async () => {
      ...
      await page.waitForSelector('.topic-container', { timeout: interval });
    ...
    it('Create post', async () => {
      ...
      const [request] = await Promise.all([onRequest(), page.click('.public', { timeout: interval })]);
    ...
    it('Check post title', async () => {
      ...
      await page.waitForSelector('.topic-name', { timeout: interval });
    ...
    it('Check is comment field is available', async () => {
      ...
      await page.click('.answer >> text="Post"', { timeout: interval });
